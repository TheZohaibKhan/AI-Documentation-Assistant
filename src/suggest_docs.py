...
def _push_docs_pr_for_merged(pr_number, docs_branch, docs_files, gh_token):
    ...
    try:
        ...
        pr_body = (
            ...
            + "\n\n*Assisted by AI Documentation Assistant*"
        )
        ...
        if missing_jira:
            ...
            if pr_number and pr_number != "unknown":
                ...
                msg = (
                    ...
                    "For setup details, see the [configuration guide](https://github.com/TheZohaibKhan/AI-Documentation-Assistant#configure-github-secrets)."
                )
